<template>
    <div class="blog-info">
        <div class="blog">
            <div class="blog-input">
                <form>
                    ...
                    <label>
                        <p>内容</p>
                        <textarea name="content" v-model.trim="content" placeholder="期待您的交流内容"
        ...
        <div class="blog-msg" v-if="substrmsg">
...
<style lang="less" scoped>
    .blog-info {
        ...
        .blog-down, .blog-up{
            ...
            border-width: 0.1rem;
            border-style: solid;
            border-color: transparent #008000 #008000 transparent;
            width: 1rem;
            height: 1rem;
            position:absolute;
            left:50%;
